...
class Agent:
    ...
    def run(self,is_training=True,render=False):
        ...
        for episode in itertools.count():
            state,_ =env.reset()
            state=torch.tensor(state,dtype=torch.float,device=device)/512.0 #############################################################
            ...
            while (not terminated and episode_reward <self.reward_threshold):
                ...
                if is_training:
                    ...
                    steps += 1
                        ...
                        # Start training only after enough experiences
                    if len(memory) > 1000:
    ...
    #env.close()  ---we want manually close
    ...
    def optimize(self,mini_batch,policy_dqn,target_dqn):
        ...
        with torch.no_grad():
            ...
            target_q = rewards + self.gamma * (1.0 - terminations) * next_q
...
if __name__ == "__main__":
    ...
    parser =argparse.ArgumentParser(description='Train ot test model.')
